...
class Doctors(models.Model):
  user = models.OneToOneField(Users, on_delete=models.CASCADE, primary_key=True, related_name='doctor')
  specialty = models.ForeignKey(Specialty,on_delete=models.CASCADE)
  bio = models.TextField()
  consult_hour = models.CharField(max_length=50, blank=True)
  consult_fee = models.CharField(max_length=50, blank=True)
...
class Patients(models.Model):
  user = models.OneToOneField(Users, on_delete=models.CASCADE, primary_key=True, related_name='patient')
